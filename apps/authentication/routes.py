...
def register():
    ...
    if 'register' in request.form:
        ...
        #request.form.pop('csrf_token', None)
        user = Users(full_name=request.form['full_name'],phone=request.form['phone'],password=generate_password_hash(request.form.get('password'))) 
